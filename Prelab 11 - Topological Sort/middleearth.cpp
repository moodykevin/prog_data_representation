...
/**
 * @brief Creates a randomized map of Middle Earth
 *
 * @return None
 * @param xsize The horizontal size of the map
 * @param ysize The vertical size of the map
 * @param num_cities The Number of cities
 * @param seed A number to use for the RNG
 * @date April 25 2022
 * @warning LOTR is a slippery slope, so don't get too involved
**/
...
/**
 * @brief Computes and returns the distances between two passed cities
 * @return The distance between two cities as a float
